...
(gtk_accel_path "<Actions>/ThunarWindow/open-parent" "F6")
...
(gtk_accel_path "<Actions>/ThunarStandardView/forward" "F7")
...
(gtk_accel_path "<Actions>/ThunarWindow/reload-alt-1" "")
